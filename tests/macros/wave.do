...
add wave -noupdate -group Ports    -label in  -radix binary /cpu_tb/in
add wave -noupdate -group Ports    -label out -radix binary /cpu_tb/out
...
add wave -noupdate -group Decode -label in  -radix hexadecimal /cpu_tb/cpu/in
...
add wave -noupdate -group Decode -group control -label inSignal   -radix binary /cpu_tb/cpu/inSignal
add wave -noupdate -group Decode -group control -label outSignal  -radix binary /cpu_tb/cpu/outSignal
...
add wave -noupdate -group Execute -label in -radix hexadecimal /cpu_tb/cpu/ex_in
...
add wave -noupdate -group Decode -group control -label inSignal -radix binary /cpu_tb/cpu/ex_inSignal
add wave -noupdate -group Decode -group control -label outSignal -radix binary /cpu_tb/cpu/ex_outSignal
...
add wave -noupdate -group Memory -group control -label outSignal -radix binary /cpu_tb/cpu/me_outSignal
...
add wave -noupdate -group Write -group control -label outSignal -radix binary /cpu_tb/cpu/wb_outSignal
