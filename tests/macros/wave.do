...
add wave -noupdate -group Fetch -label target -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/target
add wave -noupdate -group Fetch -label pc_in -radix hexadecimal /cpu_tb/cpu/pc_reg/pc_in
add wave -noupdate -group Fetch -label pc -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/pc
add wave -noupdate -group Fetch -label instr -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/instr
add wave -noupdate -group Decode -label pc -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/id_pc
add wave -noupdate -group Decode -label instr -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/id_instr
...
add wave -noupdate -group Execute -label pc -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/ex_pc
add wave -noupdate -group Execute -label rdst -radix unsigned -radixshowbase 0 /cpu_tb/cpu/ex_rdst
add wave -noupdate -group Execute -label rsrc1 -radix unsigned -radixshowbase 0 /cpu_tb/cpu/ex_rsrc1
add wave -noupdate -group Execute -label rsrc2 -radix unsigned -radixshowbase 0 /cpu_tb/cpu/ex_rsrc2
...
add wave -noupdate -group Execute -label s1 -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/s1
add wave -noupdate -group Execute -label s2 -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/s2
...
add wave -noupdate -group Memory -label pc -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/me_pc
add wave -noupdate -group Memory -label rdst -radix unsigned -radixshowbase 0 /cpu_tb/cpu/me_rdst
add wave -noupdate -group Memory -label s1 -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/me_s1
add wave -noupdate -group Memory -label r -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/me_r
add wave -noupdate -group Memory -label s2 -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/me_s2
...
add wave -noupdate -group Write -label wd -radix hexadecimal -radixshowbase 0 /cpu_tb/cpu/wd
